...
silent only
cd ~/projects/sdb/system/src/boot
...
setlocal foldenable
set foldexpr=getline(v:lnum)[0]==\"^\\s{1,}\\v\"
setlocal foldexpr=getline(v:lnum)[0]==\"^\\s{1,}\\v\"
setlocal foldignore=#
